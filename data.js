...
filterSection.map((e) => console.log(e));

filterSection.map(({ id, name, options }) => {
  options.map(({ label, value, checked }) =>
    console.log(label, value, checked, id)
  );
});

// export const filterCategoriesData = {
